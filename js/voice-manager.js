/* ============================================================================
   ...
   Butuh: voice-config.js (window.NexaVoiceConfig)
   ...
   tetap menjalankan timeline per kata memakai `duration` dari voice-config.js dan
...
(function () {
  ...
  var VM = {
    ...
    /* ------------------------------------------------------------ helpers */
    _url: function (line) {
      // override di assets/asset-registry.json menang atas path default di voice-config.js
